...
function ENT:Draw()
	...
	pos = pos + oang:Forward() * 20 + oang:Up() * 30  + oang:Right() * 0

	if alpha > 0 then
		cam.Start3D2D( pos, ang, 0.025 )
			draw.SimpleText( 'Получение оружия', 'font_sans_3d2d_large', 0, 0, Color(52, 147, 235, alpha), TEXT_ALIGN_CENTER )
			draw.SimpleText( 'Получить, либо сдать вооружение и экипировку можно тут.', 'font_sans_3d2d_small', 0, 128, Color(255,255,255, alpha), TEXT_ALIGN_CENTER )			
